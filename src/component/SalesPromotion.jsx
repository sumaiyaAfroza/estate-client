    ...
    return (
      ...
      >
        <div className="max-w-6xl mx-auto px-4">
          ...
          <motion.div
            className={`rounded-xl p-8 mb-8 relative overflow-hidden ${
              isDarkMode
                ...
                : 'bg-gradient-to-r from-emerald-900 to-blue-500 text-white dark:bg-gradient-to-r dark:from-emerald-900 dark:to-black'
            }`}
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <motion.h3
                      className={`text-lg font-bold mb-2 ${
                        isDarkMode ? 'text-gray-100' : 'dark:text-white text-gray-800'
                      }`}
          ...
          {/* Special Offers */}
          <h1 className="text-4xl font-semibold mt-20 mb-8 bg-gradient-to-r from-emerald-500 via-blue-500 to-purple-500 bg-clip-text text-transparent text-center">
            Special Offers
          </h1>
          <motion.div
            className={`rounded-lg p-6 shadow-2xl dark:border bg-white dark:bg-gray-800`}
            initial="hidden"
            animate="visible"
            variants={{
              hidden: { opacity: 0 },
              ...
              {[
                {
                  ...
                  desc: 'Book within next 7 days and get additional 5% off',
                  value: 'Save up to ৳5 Lakh',
                  color: isDarkMode ? 'bg-green-900 text-green-300 dark:text-white' : 'bg-green-100 text-green-800',
                  border: 'border-green-500',
                },
                {
                  title: 'Referral Bonus',
                  desc: 'Refer a friend and both get ৳50,000 cashback',
                  value: '৳50,000 Each',
                ...
                },
                {
                  ...
                  desc: 'Pay in easy installments with 0% interest',
                  value: '0% Interest',
                  color: isDarkMode ? 'bg-green-100 text-green-300' : 'bg-green-100 text-green-800',
                  border: 'border-purple-500',
                },
                {
                  title: 'Free Legal Support',
                  desc: 'Complete legal documentation handled by us',
                  value: 'Worth ৳1 Lakh',
                  color: isDarkMode ? 'bg-orange-900 text-orange-300' : 'bg-blue-100 text-blue-800',
